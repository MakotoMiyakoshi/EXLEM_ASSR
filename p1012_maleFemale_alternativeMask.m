...
nullMask = zeros(size(currentData));
...
gmFXS_M_mask = logical(currentData.*inclusionMask);
...
inclusionMask = nullMask;
inclusionMask(deltaThetaAlphaIdx, [onsetIdx offsetIdx]) = 1;
gmFXS_F_mask = logical(currentData.*inclusionMask);
...
inclusionMask = nullMask;
inclusionMask(deltaThetaAlphaIdx, [onsetIdx offsetIdx]) = 1;
gmHCS_M_mask = logical(currentData.*inclusionMask);
...
inclusionMask = nullMask;
inclusionMask(deltaThetaAlphaIdx, [onsetIdx offsetIdx]) = 1;
gmHCS_F_mask = logical(currentData.*inclusionMask);
...
hold on
contour(timeBins, 1:100, gmFXS_M_mask,  '-k')
...
hold on
contour(timeBins, 1:100, gmFXS_F_mask,  '-k')
set(gca, 'ytick', freqIdx, 'yticklabel', freqLabels)
colormap jet
axis xy
axis square
...
hold on
contour(timeBins, 1:100, gmHCS_M_mask,  '-k')
set(gca, 'ytick', freqIdx, 'yticklabel', freqLabels)
colormap jet
axis xy
axis square
...
hold on
contour(timeBins, 1:100, gmHCS_F_mask,  '-k')
set(gca, 'ytick', freqIdx, 'yticklabel', freqLabels)
colormap jet
axis xy
axis square
...
% Define onsetMask and offsetMask.
onsetMask  = nullMask;
onsetMask( deltaThetaIdx, onsetIdx)  = 1;
offsetMask = nullMask;
offsetMask(deltaThetaIdx, offsetIdx) = 1;
gmFXS_M_onsetMask  = gmFXS_M_mask.*onsetMask;
gmFXS_M_offsetMask = gmFXS_M_mask.*offsetMask;
gmFXS_F_onsetMask  = gmFXS_F_mask.*onsetMask;
gmFXS_F_offsetMask = gmHCS_F_mask.*offsetMask;
gmHCS_M_onsetMask  = gmHCS_M_mask.*onsetMask;
gmHCS_M_offsetMask = gmHCS_M_mask.*offsetMask;
gmHCS_F_onsetMask  = gmHCS_F_mask.*onsetMask;
gmHCS_F_offsetMask = gmHCS_F_mask.*offsetMask;
