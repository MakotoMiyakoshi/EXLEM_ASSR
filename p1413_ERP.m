% 02/13/2025 Makoto. Bug fixed for ASSR std.
...
h = daboxplot({squeeze(fxsERP(55,1003,:)) squeeze(hcsERP(55,1003,:))},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
...
h = daboxplot({squeeze(fxsERP(55,1100,:)) squeeze(hcsERP(55,1100,:))},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({squeeze(std(fxsERP(55,1501:4000,:),0,2)) squeeze(std(hcsERP(55,1501:4000,:),0,2))},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
% Additional test. (02/14/2025 Makoto.)
[H_psd,P_psd,C_psd,STATS_psd] = ttest2(spectra1, spectra2);
P_psd_fdr = fdr(P_psd, 0.05);
psdSignficanceIdx = find(P_psd < P_psd_fdr);
hold on
plot(freqs(psdSignficanceIdx), repmat(-36, [1 length(psdSignficanceIdx)]), 'linestyle', 'none', 'marker', '.', 'markersize', 10, 'color', [0 0 0])
...
h = daboxplot({fxs40HzPower, hcs40HzPower},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({fxsSlopePower, hcsSlopePower},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({fxs40HzPower-fxsSlopePower, hcs40HzPower-hcsSlopePower},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({squeeze(fxsERP(55,4096,:)) squeeze(hcsERP(55,4096,:))},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
exportgraphics(gcf, '/srv/Makoto/ASSR/p1413_ERP/ERPs.pdf', 'ContentType', 'vector', 'Resolution', 300, 'Colorspace', 'rgb')
save('/srv/Makoto/ASSR/p1413_ERP/resultTableErp.mat', 'resultTableErp')