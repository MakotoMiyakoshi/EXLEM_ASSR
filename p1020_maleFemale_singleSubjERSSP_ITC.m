...
print('/srv/Makoto/ASSR/p1020_maleFemale_singleSubjERSSP_ITC/ERSSP_maleFemale', '-dsvg')
print('/srv/Makoto/ASSR/p1020_maleFemale_singleSubjERSSP_ITC/ERSSP_maleFemale', '-djpeg95', '-r200')
