...
for setIdx = 1:length(allSets)
    ...
    % Save the data.
    pop_saveset(EEG, 'filename', loadName, 'filepath', '/srv/Makoto/ASSR/p0450_epochNonBrainForERP');
end


%% Compute grand-mean and -median ERP.

allSets = dir('/srv/Makoto/ASSR/p0450_epochNonBrainForERP/*.set');
...
save('/srv/Makoto/ASSR/p0450_epochNonBrainForERP/meanMedianERPs_nonBrainClass', 'meanERP', 'medianERP', '-nocompression')
