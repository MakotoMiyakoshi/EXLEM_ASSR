...
save('/srv/Makoto/ASSR/p0701_visErsp_maleFemale/pTensor_FXS_M', 'pTensor_rTale', 'timeBins', 'wtFreqBins', '-nocompression')
...
% Dump pTensor_rTale.
pTensor_rTale = single(pTensor_rTale);
save('/srv/Makoto/ASSR/p0701_visErsp_maleFemale/pTensor_FXS_F', 'pTensor_rTale', 'timeBins', 'wtFreqBins', '-nocompression')
...
% Dump pTensor_rTale.
pTensor_rTale = single(pTensor_rTale);
save('/srv/Makoto/ASSR/p0701_visErsp_maleFemale/pTensor_HCS_M', 'pTensor_rTale', 'timeBins', 'wtFreqBins', '-nocompression')
...
% Dump pTensor_rTale.
pTensor_rTale = single(pTensor_rTale);
save('/srv/Makoto/ASSR/p0701_visErsp_maleFemale/pTensor_HCS_F', 'pTensor_rTale', 'timeBins', 'wtFreqBins', '-nocompression')
...
print('/srv/Makoto/ASSR/p0701_visErsp_maleFemale/ersspPower_M_F', '-dsvg')
print('/srv/Makoto/ASSR/p0701_visErsp_maleFemale/ersspPower_M_F', '-djpeg95', '-r200')