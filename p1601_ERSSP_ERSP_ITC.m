...
% end
% save('/srv/Makoto/ASSR/p1601_ERSSP_erspItc/ERSSP_ersp_FXS', 'ersspTensor', 'timeBins', 'wtFreqBins', '-nocompression')
% 
% 
% % HCS.
...
%     ersspTensor(:,:,subjIdx) = pTensorSumMasks;
% end
% save('/srv/Makoto/ASSR/p1601_ERSSP_erspItc/ERSSP_ersp_HCS', 'ersspTensor', 'timeBins', 'wtFreqBins', '-nocompression')
...
%     ersspTensor(:,:,subjIdx) = pTensorSumMasks;
% end
% save('/srv/Makoto/ASSR/p1601_ERSSP_erspItc/ERSSP_itc_FXS', 'ersspTensor', 'timeBins', 'wtFreqBins', '-nocompression')
% 
% 
% % HCS.
...
%     ersspTensor(:,:,subjIdx) = pTensorSumMasks;
% end
% save('/srv/Makoto/ASSR/p1601_ERSSP_erspItc/ERSSP_itc_HCS', 'ersspTensor', 'timeBins', 'wtFreqBins', '-nocompression')
...
h = daboxplot({fxsErsp(:,1), hcsErsp(:,1)},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
...
h = daboxplot({fxsErsp(:,2), hcsErsp(:,2)},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({fxsErsp(:,3), hcsErsp(:,3)},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({fxsItc(:,1), hcsItc(:,1)},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({fxsItc(:,2), hcsItc(:,2)},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
h = daboxplot({fxsItc(:,3), hcsItc(:,3)},'linkline', 1, 'xtlabels', {'FXS' 'HCS'}, 'whiskers',0,'outliers',0,'outsymbol','r*','scatter',2,'boxalpha',0.6);
h.bx(1).FaceColor = [1 0 0];
h.bx(2).FaceColor = [0 0 1];
h.bx(1).FaceAlpha = 0.2;
h.bx(2).FaceAlpha = 0.2;
...
exportgraphics(gcf, '/srv/Makoto/ASSR/p1601_ERSSP_erspItc/ERSSP_erspItc.pdf', 'ContentType', 'vector', 'Resolution', 300, 'Colorspace', 'rgb')
save('/srv/Makoto/ASSR/p1601_ERSSP_erspItc/resultTableErssp.mat', 'resultTableErssp')