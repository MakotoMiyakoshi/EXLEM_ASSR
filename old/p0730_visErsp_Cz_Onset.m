...
CzERSP_sigMask_FXS = squeeze(ersp_pTensor_FXS(elecIdx,:,:))<0.001;
    ...
    %}
CzERSP_sigMask_FXS(:, [1:850 1650:end]) = 0;
...
CzERSP_sigMask_HCS = squeeze(ersp_pTensor_HCS(elecIdx,:,:))<0.001;
    ...
    %}
CzERSP_sigMask_HCS([1:30 50:100],:)      = 0;
CzERSP_sigMask_HCS(:, [1:850 1500:5000]) = 0;
...
xlim([0.5 2.5])
ylim([0 3])
title(sprintf('Onset-evoked theta, R^2=%.3f, t(%d)=%.2f, p=%.4f', lmeModel1.Rsquared.Adjusted, lmeModel1.Coefficients.DF(2), lmeModel1.Coefficients.tStat(2), lmeModel1.Coefficients.pValue(2)))

sgtitle('Grand-mean ERSP at Cz')

print('/srv/Makoto/ASSR/p0730_visErspItc_Cz_Onset/ERSP_onsetTheta',  '-djpeg', '-r200')
print('/srv/Makoto/ASSR/p0730_visErspItc_Cz_Onset/ERSP_offsetTheta', '-dsvg', '-r200')