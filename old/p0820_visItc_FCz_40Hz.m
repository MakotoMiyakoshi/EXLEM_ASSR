...
load('/srv/Makoto/ASSR/p0700_visErspItc_13yrsPlus_stats/itc_pTensor_FXS.mat')
ersp_pTensor_FXS = pTensor_rTale;
load('/srv/Makoto/ASSR/p0700_visErspItc_13yrsPlus_stats/tic_pTensor_HCS.mat')
...
FCzERSP_FXS = squeeze(itcFXS(elecIdx,:,:));
FCzERSP_HCS = squeeze(itcHCS(elecIdx,:,:));
...
print('/srv/Makoto/ASSR/p0720_visErspItc_FCz_40Hz/ERSP_40Hz', '-djpeg', '-r200')
print('/srv/Makoto/ASSR/p0720_visErspItc_FCz_40Hz/ERSP_40Hz', '-dsvg', '-r200')