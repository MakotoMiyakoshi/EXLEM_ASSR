...
barHandle = bar([mean(onsetFXS_roiMean) mean(onsetHCS_roiMean)])
hold on
errorbar(1:2, [mean(onsetFXS_roiMean) mean(onsetHCS_roiMean)], ...
              [0 0], ...
              [std(onsetFXS_roiMean)  std(onsetHCS_roiMean)], ...
...
barHandle = bar([mean(assrFXS_roiMean) mean(assrHCS_roiMean)])
hold on
errorbar(1:2, [mean(assrFXS_roiMean) mean(assrHCS_roiMean)], ...
              [0 0], ...
              [std(assrFXS_roiMean)  std(assrHCS_roiMean)], ...
              'linestyle', 'none', 'color', [0 0 0])
set(gca,'box', 'off')
barHandle.FaceColor = "flat";
barHandle.CData     = [1 0 0; 0 0 1];
...
barHandle = bar([mean(offsetFXS_roiMean) mean(offsetHCS_roiMean)])
hold on
errorbar(1:2, [mean(offsetFXS_roiMean) mean(offsetHCS_roiMean)], ...
              [0 0], ...
              [std(offsetFXS_roiMean)  std(offsetHCS_roiMean)], ...
              'linestyle', 'none', 'color', [0 0 0])
set(gca,'box', 'off')
barHandle.FaceColor = "flat";
barHandle.CData     = [1 0 0; 0 0 1];
...
exportgraphics(gcf, '/srv/Makoto/ASSR/p1301_ersp/ERSPs.pdf', 'ContentType', 'vector', 'Resolution', 300, 'Colorspace', 'rgb')
save('/srv/Makoto/ASSR/p1301_ersp/resultTableErsp.mat', 'resultTableErsp')