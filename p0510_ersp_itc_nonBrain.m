...
%% Cz Mean ERSP.
allMats = dir('/srv/Makoto/ASSR/p0430_epochNonBrain/*_elecErspMean.mat');
...
for matIdx = 1:length(allMats)
    ...
    load(['/srv/Makoto/ASSR/p0430_epochNonBrain/' currentMat])
...
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMeanErsp', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMeanErsp', '-r200', '-dsvg')


%% Cz Median ERSP.
allMats = dir('/srv/Makoto/ASSR/p0430_epochNonBrain/*_elecErspMedian.mat');
stackData = zeros(128, 100, 5000, length(allMats));
for matIdx = 1:length(allMats)
    disp(sprintf('%d/%d', matIdx, length(allMats)))
    currentMat = allMats(matIdx).name;
...
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMedianErsp', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMedianErsp', '-r200', '-dsvg')


%% Cz Mean ITC.
allMats = dir('/srv/Makoto/ASSR/p0430_epochNonBrain/*_elecItcMean.mat');
stackData = zeros(128, 100, 5000, length(allMats));
for matIdx = 1:length(allMats)
    disp(sprintf('%d/%d', matIdx, length(allMats)))
    currentMat = allMats(matIdx).name;
...
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMeanItc', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMeanItc', '-r200', '-dsvg')


%% Cz Median ITC.
allMats = dir('/srv/Makoto/ASSR/p0430_epochNonBrain/*_elecItcMedian.mat');
stackData = zeros(128, 100, 5000, length(allMats));
for matIdx = 1:length(allMats)
    disp(sprintf('%d/%d', matIdx, length(allMats)))
    currentMat = allMats(matIdx).name;
...
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMedianItc', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0510_ersp_itc_nonBrain/czMedianItc', '-r200', '-dsvg')
