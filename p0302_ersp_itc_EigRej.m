...
%% Cz Mean ERSP.
allMats = dir('/srv/Makoto/ASSR/p0230_epoch_EigRej/*_elecErspMean.mat');
...
for matIdx = 1:length(allMats)
    ...
    load(['/srv/Makoto/ASSR/p0230_epoch_EigRej/' currentMat])
...
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMeanErsp', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMeanErsp', '-r200', '-dsvg')


%% Cz Median ERSP.
allMats = dir('/srv/Makoto/ASSR/p0230_epoch_EigRej/*_elecErspMedian.mat');
stackData = zeros(128, 100, 5000, length(allMats));
for matIdx = 1:length(allMats)
    disp(sprintf('%d/%d', matIdx, length(allMats)))
    currentMat = allMats(matIdx).name;
...
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMedianErsp', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMedianErsp', '-r200', '-dsvg')


%% Cz Mean ITC.
allMats = dir('/srv/Makoto/ASSR/p0230_epoch_EigRej/*_elecItcMean.mat');
stackData = zeros(128, 100, 5000, length(allMats));
for matIdx = 1:length(allMats)
    disp(sprintf('%d/%d', matIdx, length(allMats)))
    currentMat = allMats(matIdx).name;
...
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMeanItc', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMeanItc', '-r200', '-dsvg')


%% Cz Median ITC.
allMats = dir('/srv/Makoto/ASSR/p0230_epoch_EigRej/*_elecItcMedian.mat');
stackData = zeros(128, 100, 5000, length(allMats));
for matIdx = 1:length(allMats)
    disp(sprintf('%d/%d', matIdx, length(allMats)))
    currentMat = allMats(matIdx).name;
...
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMedianItc', '-r200', '-djpeg95')
print('/srv/Makoto/ASSR/p0302_ersp_itc_EigRej/czMedianItc', '-r200', '-dsvg')
